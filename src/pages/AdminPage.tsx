      ...
      {showServiceModal && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-auto">
            ...
            <form key={editingService?.id || 'new'} onSubmit={saveService} className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
      ...
      {showArticleModal && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl w-full max-w-2xl max-h-[90vh] overflow-auto">
            ...
            <form key={editingArticle?.id || 'new'} onSubmit={saveArticle} className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-4">
                <div>
      ...
      {showTestimonialModal && (
        <div className="fixed inset-0 bg-black/50 flex items-center justify-center p-4 z-50">
          <div className="bg-white rounded-2xl w-full max-w-lg">
            ...
            <form key={editingTestimonial?.id || 'new'} onSubmit={saveTestimonial} className="p-6 space-y-4">
              <div>
                <label className="block text-sm font-medium text-sage-700 mb-1">Nombre</label>
